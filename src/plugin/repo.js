...
const searchRepo = async (m, Matrix) => {
  ...
  if (validCommands.includes(cmd)) {
    const repoUrl = `https://api.github.com/betingrich/Mercedes`;
              ...
              buttons: [
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://wa.me/2547400075671?text=Hi_Marisel',
                  }),
                },
                {
                  name: 'cta_url',
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: 'https://github.com/betingrich/Mercedes/fork',
                  }),
                },
                {
                  name: 'cta_url',
